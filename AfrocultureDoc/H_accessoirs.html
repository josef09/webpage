...
<head>
    ...
    <link rel="stylesheet" type="text/css" href = "chaussures.css">
...
<body>
      <header class ="menu">
        <ul id = "menu1">
            ...
            <li class ="b">
                <a href = "../AfrocultureDoc/contact.html">
                    Contact
                </a>
            </li>
      ...
      <section class = "ensemble">
          ...
          <div class = "sous-titre">
              <ul id ="sous-titre1">
                  <li class ="titre">
                <a class  ="change" href = "#">Habits d'hiver</a>
                  </li>
                <li class = "titre">
                    <a href = "#">
                        Nouveaute
    ...
    <section class = "milieu">
      <div class = "containerGeneral" > 
          <div class = "entete">
            <h3><strong>Galery</strong></h3>
           <div>
          
             <div class = "container">
              
                  <div class = "element11">
                      <img alt src = "ImageAfro/foto1.jpg" alt ="dix terre" class ="fot">
                  
                  <div class= "namelem">foto1</div>
                    </div>
             
                <div class = "element11">
                    <img alt src = "ImageAfro/foto4.jpg"  class ="fot" >
                
                <div class= "namelem">foto2</div>
                  </div>
          ...
          <footer>
            <div class= "finPage">
                 Copyrightt 2012-2016 - All Right reserved 
            </div>
        </footer>

      </section>
      <section>
          <script src = "chaussures.js"></script>
      </section>
      <nav >
